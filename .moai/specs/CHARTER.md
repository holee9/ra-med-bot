...
| 쟁점 | 상태 |
|---|---|
| **PCCP 보존 vs 아카이브** | `product.md` "포함 기능" 표는 "CER/PCCP/Predicate ✅ 보존", v3 계획서 3.3절은 PCCP를 아카이브 대상으로 분류 — product.md 내부 모순, 판정 필요 |
| **RAG 코퍼스 공백** | `source_sections=19`로 사실상 비어 있음. §6의 1순위 가치가 실운영 기준 작동 불가 (이슈 #517) |
| **v3 승인 상태** | v3 계획서 상태란은 "승인 대기"이나 Phase C/D는 구현 완료 — 문구가 stale (이슈 #519) |
| **범위 이탈 5건** | SPEC 3건 + 이슈 #40/#55 판정 대기 (이슈 #520) |
