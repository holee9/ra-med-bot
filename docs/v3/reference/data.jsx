...
const D3 = {
  ...
  products: [
      ...
      markets: [
        {
          ...
          name: 'US · FDA',
          status: 'approved',
          path: '510(k) K242017 · Product Code MQB',
          since: '2024-08',
          next: 'Annual Report · 2027-08',
        },
        {
          code: 'eu',
          name: 'EU · MDR',
          status: 'in-review',
          path: 'CE MDR · Annex VIII Rule 10 후단 · TR 심사',
          since: '—',
          next: 'NB decision · 2026-Q4',
        },
        {
          code: 'kr',
          name: 'KR · MFDS',
          status: 'approved',
          path: '제조허가 제25-345호 · 2등급',
          since: '2025-03',
          next: '재심사 · 2030-03',
        },
        {
          ...
          name: 'JP · PMDA',
          status: 'planning',
          path: 'Class II · Todokede 예정',
          since: '—',
          next: 'RCB 인증 vs PMDA 承認 판단',
        },
      ],
      changes14d: 2,
    },
    {
      id: 'xray-src',
      name: 'Handheld X-ray Source',
      family: 'Radiography · Portable',
      ...
      markets: [
        {
          ...
          name: 'US · FDA',
          status: 'in-review',
          path: '510(k) 제출 · 2026-05 · Form FDA 2579·2877 필요',
          since: '—',
          next: 'AI hold · 2026-07-15',
        },
        {
          code: 'eu',
          name: 'EU · MDR',
          status: 'approved',
          path: 'CE 0086 · Class IIb · NB 전수 심사',
          since: '2023-11',
          next: 'Surveillance audit · 2026-09',
        },
        {
          code: 'kr',
          name: 'KR · MFDS',
          status: 'approved',
          path: '제조허가 · 2등급 · 방사선안전관리 규칙 2025-07-18 개정 대응',
          since: '2023-06',
          next: '변경허가 심사 중',
        },
        {
          ...
          name: 'CN · NMPA',
          status: 'planning',
          path: 'NMPA · GB 9706.1-2020 강화 조항 · CMDE 지정 검사 예정',
          since: '—',
          next: '재시험 대기 · 2027-02',
        },
      ],
    ...
    },
    {
      ...
      standards: [
        'IEC 62304:2006/A1:2015 (Class B)',
        'IEC 82304-1:2016',
        'IEC 62366-1',
        'IEC 81001-5-1:2021 (Cybersecurity)',
        'ISO 14971:2019',
        'MDCG 2019-11 Rev.1',
        'FDA PCCP 2024-12 (AI/ML)',
      ],
      ...
      markets: [
        {
          ...
          name: 'US · FDA',
          status: 'in-review',
          path: '510(k) · Cyber Device · SBOM 제출 완료',
          since: '—',
          next: 'AI Sub-review · 2026-08',
        },
        {
          code: 'eu',
          name: 'EU · MDR',
          status: 'planning',
          path: 'Rule 11 · Class IIa 예상 · MDCG 2019-11 Rev.1 (2025-06) 반영',
          since: '—',
          next: 'NB 지정 대기',
        },
        {
          ...
          name: 'KR · MFDS',
          status: 'approved',
          path: '제조허가 · 디지털의료제품법(2025-01-24) 적용 · CMP 등록',
          since: '2025-05',
          next: 'CMP 재평가 · 2026-11',
        },
      ],
      changes14d: 3,
    },
  ...
  myQuestions: [
    {
      id: 'Q-3401',
      at: '2026-06-30 15:22',
      q: 'EEG 헤드셋에 BLE 5.3 SoC로 교체하면 재인허가 필요한가요?',
      product: '촬영실 GUI SW',
      market: 'US · EU',
    ...
    },
    {
      id: 'Q-3399',
      at: '2026-06-28 11:03',
      q: 'IEC 62304 Class B SW에서 오픈소스 라이브러리(Apache-2.0) 사용 시 문서화?',
      product: '촬영실 GUI SW',
      state: 'answered',
      ...
      raAssignee: 'S. Park',
      answer:
        '오픈소스 라이브러리는 SOUP(Software of Unknown Provenance)로 분류 · IEC 62304 §5.3.3에 따라 anomaly list 관리, §7.1.2 위험 분석 필요. 승인된 답변집에 등록되어 있습니다.',
    },
    {
      id: 'Q-3395',
      at: '2026-06-25 09:40',
      q: '독일 시장 진출 시 IFU 언어를 영어만 제공해도 되나요?',
      product: '촬영실 GUI SW',
      market: 'EU · DE',
      state: 'answered',
      autoConfidence: 94,
      answer:
        '아니오. MDR Art. 10(11) + DE MPDG §8 — 최종 사용자(Lay/HCP)가 이해할 수 있는 언어. 독일은 독일어 필수.',
    },
    {
      id: 'Q-3392',
      at: '2026-06-24 17:12',
      q: 'AI 알고리즘 재학습 결과를 배포하려면 SW 변경관리?',
      product: '촬영실 GUI SW',
      market: 'US',
      state: 'escalated',
    ...
    },
    {
      id: 'Q-3388',
      at: '2026-06-23 10:00',
      q: '마케팅 자료에 "clinically proven"이라는 문구를 써도 되나요?',
      product: '촬영실 GUI SW',
      market: 'US · EU',
      state: 'waiting',
  ...
  guides: [
    ...
    },
    {
      id: 'g3',
      cat: 'AI/ML',
      q: 'PCCP (Predetermined Change Control Plan) 적용 조건',
      updated: '2026-05',
      hits: 76,
    },
  ...
  inbox: [
    {
      id: 'Q-3406',
      at: '2026-07-01 09:15',
      q: '수출용 라벨에 UDI-DI만 있으면 되나요, PI도 필요?',
      ...
      confidence: 91,
      slaTarget: '2026-07-01 13:15',
      slaRemaining: '3h',
      slaOk: true,
      draft:
        'MDR Art. 27 · UDI Rule: EUDAMED 등록에는 UDI-DI + PI 모두 필요. 라벨 자체에는 상황별로 다름 — 다회용은 PI 없이 UDI-DI만도 허용.',
      tags: ['Labeling', 'UDI'],
    },
    {
      id: 'Q-3405',
      at: '2026-07-01 08:42',
      q: 'PMS 데이터를 CER 업데이트에 언제 반영해야 하나요?',
      from: { name: 'Mina Lee', dept: 'R&D HW', avatar: 'ML' },
      product: 'Handheld X-ray Source',
      market: 'EU',
      triage: 'auto',
      confidence: 87,
      slaTarget: '2026-07-01 12:42',
      slaRemaining: '2h',
      slaOk: true,
    ...
    },
    {
      id: 'Q-3401',
      at: '2026-06-30 15:22',
      q: 'BLE 5.3 SoC 교체 시 재인허가?',
      from: { name: 'Yuna Kim', dept: 'R&D SW', avatar: 'YK' },
      product: '촬영실 GUI SW',
      market: 'US · EU',
      triage: 'needs-review',
      confidence: 62,
      slaTarget: '2026-07-02 15:22',
      slaRemaining: '32h',
      slaOk: true,
      draft:
        '<b>초안 (신뢰도 62%)</b>: 무선 스택 변경은 US 21 CFR 807.81 + EU MDR Art. 21 재검토 필요. 반드시 확인:\n· 이전 인증과 동일 profile인지\n· 방사 파워 범위 변경 여부\n· EMC 재시험 필요성',
      assignee: 'S. Park',
    ...
    },
    {
      id: 'Q-3388',
      at: '2026-06-23 10:00',
      q: '"clinically proven" 문구 사용 가능?',
      from: { name: 'Yuna Kim', dept: 'R&D SW', avatar: 'YK' },
      product: '촬영실 GUI SW',
      triage: 'waiting', // waiting for user clarification
      confidence: 71,
      slaTarget: '2026-06-24',
      slaRemaining: 'user-input',
      slaOk: true,
    ...
    },
    {
      id: 'Q-3403',
      at: '2026-06-30 13:10',
      q: '중국 NMPA 등록 시 한국 시험성적서 재사용?',
      from: { name: 'Jihun Han', dept: 'R&D HW', avatar: 'JH' },
      product: 'X-ray Detector',
      market: 'CN',
      triage: 'auto',
      confidence: 82,
      slaTarget: '2026-07-01 13:10',
      slaRemaining: '3h',
      slaOk: true,
      draft:
        'NMPA 2021 개정으로 KTL/KTC 시험성적서 부분 인정 (일부 항목만). 반드시 NMPA-recognized lab 재시험 필요 항목 확인.',
      tags: ['NMPA', 'Testing'],
    },
    {
      id: 'Q-3400',
      at: '2026-06-29 14:22',
      q: '재사용 의료기기 세척·소독 검증 요구사항',
      from: { name: 'Kyu Cho', dept: 'R&D SW', avatar: 'KC' },
      product: 'X-ray Detector',
      triage: 'needs-review',
      confidence: 68,
      slaTarget: '2026-07-01 14:22',
      slaRemaining: '5h',
      slaOk: true,
      draft:
        '<b>초안 (68%)</b>: FDA Reprocessing Guidance (2015) · ISO 17664. 세척·소독·멸균 각각 IFU에 명시.',
      assignee: null,
  ...
  radar: [
    ...
    },
    {
      ...
      date: '2026-06-20',
      tag: 'MDCG',
      ttl: 'MDCG 2026-3 · PMCF 평가 보고서 템플릿',
      sev: 'high',
      impact: [
        { pid: 'gui-sw', sev: 'high', note: 'EU 심사 중 — 신규 템플릿 적용 필요' },
    ...
    },
    {
      ...
      date: '2026-06-12',
      tag: 'MFDS',
      ttl: 'SaMD 변경허가 가이드 v2.0 의견조회',
      sev: 'med',
      impact: [
        { pid: 'gui-sw', sev: 'low', note: '알고리즘 변경 시 참조' },
    ...
    },
    {
      ...
      date: '2026-06-05',
      tag: 'FDA',
      ttl: 'AI/ML SaMD PCCP 최종 가이드 (Q&A 추가)',
      sev: 'high',
    ...
    },
    {
      ...
      date: '2026-05-28',
      tag: 'IMDRF',
      ttl: 'Cybersecurity for Legacy Devices Guide',
      sev: 'low',
      impact: [],
    },
  ],
  ...
  adminUsers: [
    ...
    },
    {
      id: 'u_seojin',
      name: 'Seojin Park',
      email: 'seojin.park@neurosense.kr',
      role: 'ra-lead',
      team: 'RA',
      status: 'active',
      last: '10분 전',
    ...
    },
    {
      id: 'u_doyeon',
      name: 'Doyeon Ryu',
      email: 'doyeon.ryu@neurosense.kr',
      role: 'employee',
      team: 'Regulatory Ops',
      status: 'active',
      last: '2일 전',
    },
    {
      id: 'u_ha',
      name: 'Hyunjoo Ha',
      email: 'hyunjoo.ha@neurosense.kr',
      role: 'employee',
      team: 'Marketing',
      status: 'active',
      last: '3일 전',
    },
    {
      id: 'u_bs',
      name: 'Byungsoo Oh',
      email: 'byungsoo.oh@neurosense.kr',
      role: 'employee',
      team: 'Clinical Ops',
      status: 'active',
      last: '1주 전',
    ...
    },
    {
      id: 'u_admin',
      name: 'Jaehyun Yoon',
      email: 'jaehyun.yoon@neurosense.kr',
      role: 'admin',
      team: 'IT · Platform',
      status: 'active',
      last: '2분 전',
  ...
  adminRoles: [
    {
      ...
      label: 'Employee',
      count: 26,
      perms: ['ask', 'read guides', 'submit tickets'],
    },
    { id: 'viewer', label: 'Viewer', count: 4, perms: ['read only'] },
    {
      ...
      label: 'RA Member',
      count: 12,
      perms: ['inbox triage', 'authored ESIG', 'knowledge draft'],
    },
    {
      id: 'ra-lead',
      label: 'RA Lead',
      count: 4,
      perms: ['approve ESIG', 'escalate', 'knowledge publish'],
    },
  ...
  systemAuditLog: [
    {
      ts: '2026-07-01 10:14:22',
      actor: 'Seojin Park',
      action: 'inbox.approve',
      target: 'Q-3406',
      ip: '10.0.4.12',
      meta: 'ESIG · Approved · SHA-256:a4e1…',
    },
    {
      ts: '2026-07-01 09:58:03',
      actor: 'Regula AI',
      action: 'triage.auto',
      target: 'Q-3406',
      ip: 'internal',
    ...
    {
      ts: '2026-07-01 09:42:15',
      actor: 'Jihun Han',
      action: 'knowledge.publish',
      target: 'K-2026-342',
      ip: '10.0.4.18',
      meta: 'from C-2026-036',
    },
    {
      ts: '2026-07-01 08:17:44',
      actor: 'System',
      action: 'rag.reindex',
      target: 'corpus:mdcg',
      ip: 'internal',
      meta: '+ MDCG 2026-3 · MDCG 2024-9',
    },
    {
      ts: '2026-06-30 23:00:00',
      actor: 'System',
      action: 'radar.scrape',
      target: 'source:fda-rss',
      ip: 'internal',
      meta: '4 new items',
    },
    {
      ts: '2026-06-30 18:33:41',
      actor: 'Jaehyun Yoon',
      action: 'role.grant',
      target: 'u_kyu',
      ip: '10.0.4.5',
      meta: 'employee → ra-member (denied · policy)',
    },
    {
      ts: '2026-06-30 16:20:55',
      actor: 'Jihun Han',
      action: 'inbox.escalate',
      target: 'Q-3392',
      ip: '10.0.4.18',
      meta: '→ External counsel (Kim & Lee)',
    },
    {
      ts: '2026-06-30 14:11:01',
      actor: 'Jaehyun Yoon',
      action: 'settings.update',
      target: 'sla.needs-review',
      ip: '10.0.4.5',
      meta: '24h → 12h',
    },
    {
      ...
      target: 'u_seojin',
      ip: '10.0.4.12',
      meta: 'Google Workspace',
    },
    {
      ts: '2026-06-29 22:04:12',
      actor: 'Regula AI',
      action: 'triage.escalate',
      target: 'Q-3392',
      ip: 'internal',
      meta: 'confidence 41% < threshold',
    },
  ],
  ...
  ragCorpus: [
    ...
    {
      id: 'c-nas-wiki',
      name: 'RA LLM Wiki (사내 NAS · 인제스트)',
      repo: 'DR_RnD/ra-llm-wiki',
      host: 'nas',
    ...
    {
      id: 'c-md-process',
      name: 'MD-Process · 의료기기 제조·업무규칙',
      repo: 'holee9/MD-process',
      host: 'github',
      hostUrl: 'https://github.com/holee9/MD-process',
      branch: 'main',
      path: '/ (10 카테고리 전체)',
      auth: 'github-app',
      docs: 70,
    ...
    {
      id: 'c-ra-project',
      name: 'RA-Project · 인허가 지식베이스',
      repo: 'holee9/ra-project',
      host: 'github',
      hostUrl: 'https://github.com/holee9/ra-project',
      branch: 'main',
      path: '01_규제지식베이스/ + 04_기술문서_템플릿/ + 06_심사_QA이력/',
      auth: 'github-app',
      docs: 168,
      size: '18 MB',
      lastSync: '2026-07-01 07:00',
      commit: 'ad6f950…',
      status: 'ok',
      cron: 'daily 03:40 + 주간 심층 월07:00',
  ...
  dbStores: [
    {
      ...
      name: '승인 답변집',
      kind: 'hybrid',
      tech: 'PostgreSQL + nightly Git 스냅샷',
      rows: 342,
      size: '18 MB',
      growth: '+18 이번달',
      retention: '5년',
    ...
    },
    {
      ...
      name: 'Audit Log · 감사추적',
      kind: 'db-immutable',
      tech: 'PostgreSQL append-only + SHA-256 chain',
      rows: 12480,
      size: '148 MB',
      growth: '+1240 이번주',
    ...
    {
      id: 'visual_assets',
      name: 'Visual Assets · 도해',
      kind: 'object-storage',
      tech: 'S3 (R2) + PostgreSQL 메타',
      rows: 84,
      size: '340 MB',
      growth: '+8 이번달',
      retention: '5년',
  ...
  personas: [
    // ── Employees (5) ─────────────────────────────────────────
    {
      ...
      initials: 'YK',
      age: 34,
      title: 'Senior SW Engineer · AI/ML',
      team: 'R&D · SW / AI Team',
      bg: 'KAIST 전산 학사 · Samsung Medison AI 6년 · IEC 62304 Class B/C SW 4건 리드 · MLOps 파이프라인 자체 구축',
      creds:
        'IEC 62304 · IEC 82304 · GMLP · FDA PCCP Draft 대응 2건 · PyTorch/CycloneDX · SBOM 스택 실무',
      crossCheck:
        'IEC 62304 §5-§9 전 조항 인용 가능 · FDA GMLP 5원칙 실무 적용 · SaMD IMDRF N12 준수',
      evaluationScope: [
        'employee/ask',
        'employee/impact',
        'employee/myqs',
      ...
      redLines: [
        'SW 변경 판단이 IEC 62304 §5.7 unresolved SOUP 확인 없이 결정되면 안됨',
        'PCCP 없이 재학습 배포 판단 금지',
      ],
    ...
    },
    {
      ...
      initials: 'JH',
      age: 41,
      title: 'Principal HW Engineer · X-ray Systems',
      team: 'R&D · HW',
      bg: '서울대 전기공학 박사 · Vieworks 8년 · X-ray Detector 3건 FDA 510(k) 통과 · EMC lab 5회 무결점 통과',
      creds:
        'IEC 60601-1 · IEC 60601-1-2 4판 · IEC 60601-2-54 · CB Test 절차 · KTL/UL EMC 실무 · GB 9706 시리즈',
      crossCheck:
        'IEC 60601-1-2:2020 §7 tailoring 근거 인용 가능 · CB Report 재활용 판단 3지역 실무 · GB 9706.1-2020 강화 조항 매핑 보유',
      evaluationScope: [
        'employee/products',
        'employee/impact(HW)',
        'employee/ask(HW)',
        'ra/submissions(HW 관점)',
      ],
      redLines: [
        'EMC 재시험 판단이 tailoring 근거 없이 skip되면 안됨',
        'IEC 60601-1 3rd amd 반영 안된 답변 인용 금지',
      ],
      decisionWeight: { hw: 5, emc: 5, submissions: 3, ra: 2, sw: 1 },
      goals: [
        'BOM 변경 시 재시험 범위 즉시 판단',
        'Predicate 비교표 자동 생성',
        '3지역 시험성적서 재활용',
      ],
      pains: [
        'RA 판단 대기 평균 2.4일',
        'NMPA GB 9706 강화 조항 케이스별 판단',
        'CB Test 재활용 범위 불명',
      ],
      literacy: 'medium',
      quote:
        '"GB 9706 강화 조항을 IEC 60601 대비 표로 보여주면 재시험 예산 결정이 하루 걸리던 게 30분에 끝난다."',
    },
    {
      id: 'p_doyeon',
      persona: 'employee',
      ...
      initials: 'DR',
      age: 38,
      title: 'Regulatory Ops Manager',
      team: 'Regulatory Operations',
      bg: '연세대 생명공학 박사 · GE Healthcare 5년 · 사내 문서·UDI·EUDAMED 운영 · MFDS 재심사 3건 관리',
      creds:
        'ISO 13485 IA · UDI/GS1 · EUDAMED 4모듈 실무 · ISO 15223-1 심볼 감사 · SharePoint QMS 통합',
      crossCheck:
        'MDR Art. 27 UDI-DI/PI 갱신 트리거 5조건 인용 가능 · EUDAMED Actor/UDI/Device/Vigilance 모듈 실무',
      evaluationScope: [
        'employee/products(라벨/UDI)',
        'employee/guides',
        'employee/myqs',
        'ra/knowledge(SOP 관점)',
        'admin/corpus(사내 SOP)',
      ...
      redLines: [
        'UDI 갱신 필요 판정이 MDR Art. 27 5조건 체크 없이 결정되면 안됨',
        'IFU 언어 잠금이 ISO 15223-1 심볼 감사 없이 진행되면 안됨',
      ],
    ...
    },
    {
      ...
      creds:
        '의료기기 광고심의(KRDIA) · FTC Truth-in-Advertising · MHRA advertising code · MKT 캠페인 15+',
      crossCheck:
        'MFDS 의료기기법 §24 표시·광고 위반 사례 실무 · FTC 15 U.S.C. §55(a) 표시 규정 인용 가능',
      evaluationScope: [
        'employee/ask(claim)',
        'employee/guides(광고)',
        'employee/myqs',
        'employee/impact(마케팅 자료 변경)',
      ],
      redLines: [
        '"clinically proven" 등 claim이 임상 근거 없이 사용되면 안됨',
        '해외 자료 번역 시 현지 광고 규제 미반영 금지',
      ],
    ...
    },
    {
      ...
      initials: 'BO',
      age: 47,
      title: 'Clinical Affairs Lead · MD/PhD',
      team: 'Clinical Operations',
      bg: 'MD/PhD 임상병리 · Boston Scientific US 8년 · CER 6건 · PMCF 조사 3건 · ISO 14155 CI 지속 인증',
      creds:
        'MD · CCRA · ISO 14155 · MDCG 2020-5/6/7/8 · IRB Chair 3년 · Real-World Evidence 프레임워크',
      crossCheck:
        'MDR Art. 61 임상평가 요구 실무 · MDCG 2020-6 sufficient clinical evidence 판단 · MDR Annex XIV Part A/B 조항 인용',
      evaluationScope: [
        'ra/consult(CER/PMCF)',
        'employee/impact(임상)',
        'employee/myqs',
      ...
      redLines: [
        '임상 확장(intended purpose)이 신규 임상평가 없이 진행되면 안됨',
        'PMS→CER 피드백 루프가 6개월 이상 단절되면 안됨',
      ],
    ...
    // ── RA (3) ────────────────────────────────────────────────
    {
      ...
      creds:
        'RAC-Global · MDR/FDA/MFDS/NMPA/PMDA 승인 12건 · ISO 13485 Lead Auditor · 21 CFR Part 11 감사 통과 3회',
      ...
      evaluationScope: [
        ...
        'ra/consult(팀 재사용)',
        'admin/logs(감사)',
        'ra/knowledge(publish 승인)',
      ],
      redLines: [
        'ESIG가 21 CFR §11.200(a)(1) 두 요소 재입력 없이 통과되면 안됨',
        '팀 SLA 90% 미만이면 backlog에서 이 문제 최우선',
        '단독 의견 기반 필수 승인 안 함',
      ],
      ...
      literacy: 'high',
      quote:
        '"단독 의견을 backlog 필수로 밀어붙이는 순간 팀 신뢰가 무너진다. 회의록이 유일한 근거."',
    },
    {
      id: 'p_mina',
      persona: 'ra',
      ...
      initials: 'ML',
      age: 39,
      title: 'Senior RA Specialist · Global',
      team: 'RA',
      bg: '서울대 약학 · Siemens Healthineers 독일 지사 4년 · 12년 · MDR TR 8건 · FDA Pre-Sub 6건 · MDCG WG 옵서버',
      creds:
        'RAC(US) + RAC(EU) · MDR TR 8건 · FDA Pre-Sub 6건 · MDCG 2020-3/6/8 WG 참여 · Q-Sub 실무',
      crossCheck:
        'MDR Annex II §6.1.b 임상평가 절차 · FDA Pre-Sub Program 실무 · Notified Body Deficiency Letter 대응 통계',
      evaluationScope: [
        'ra/consult(다국어)',
        'ra/submissions',
        'ra/radar',
        'ra/knowledge',
        'employee/impact(다국가 관점)',
      ],
      redLines: [
        'MDR/FDA 이중 제출에서 동등성 근거 불일치 허용 안 함',
        'Notified Body 답변에 근거 조항 미명시 금지',
      ],
      decisionWeight: { global_ra: 5, mdr: 5, fda: 5, submissions: 4, ra: 4, ux: 3 },
      goals: ['MDR + FDA 문서 재활용 극대화', 'NB Deficiency 리스크 최소화', 'PCCP 사내 표준'],
      pains: [
        'MDR 심사관별 판단 차이',
        'FDA AI Request 답변 톤 부재',
        'MDR simplification(COM 2025/1023) 추적 부담',
      ],
      literacy: 'high',
      quote:
        '"Consult에서 관할권 3개 병렬 비교가 엑셀 매트릭스를 대체하면 팀 재사용성이 극대화된다."',
    },
    {
      id: 'p_kyu',
      persona: 'ra',
      ...
      initials: 'KC',
      age: 34,
      title: 'RA Specialist · Asia',
      team: 'RA',
      bg: '고려대 약학 · 사내 성장 8년 · MFDS/NMPA/PMDA 3개국 등록 3건 · 중문/일문 실무 가능',
      creds:
        'RAC(APAC) · MFDS 실무 · NMPA CFDI 심사 3회 · PMDA Type-II 상담 5회 · GB 9706 시리즈 대응',
      crossCheck:
        'MFDS 고시 2025-01 사이버보안 조항 · NMPA Order No.47 (2021) 변경 사항 · PMDA 通知 실무',
      evaluationScope: [
        'ra/consult(APAC)',
        'ra/submissions(NMPA/PMDA)',
        'ra/radar(중일 원문)',
        'employee/products(APAC 등록)',
      ],
      redLines: [
        'MFDS 신규 고시 SLA 24h 초과 답변 금지',
        'NMPA 재시험 판단이 GB 9706 강화 조항 매핑 없이 결정 금지',
      ],
      decisionWeight: { apac: 5, mfds: 5, nmpa: 5, pmda: 5, ra: 3, ux: 3 },
      goals: [
        'MFDS 고시 24h 반영',
        'NMPA Order No.47 재시험 판정 자동화',
        'PMDA Type-II 준비 표준화',
      ],
      pains: [
        'MFDS 사이버보안 개정 케이스별 판단',
        '중문/일문 해석 시간',
        '3개국 라벨 잠금 파편화',
      ],
      literacy: 'high',
      quote:
        '"중문/일문 원문 hover-preview가 있으면 심사관 커뮤니케이션의 근거로 그대로 사용 가능."',
    },
    // ── Admin (1) ─────────────────────────────────────────────
    {
      id: 'p_jaehyun',
      ...
      initials: 'JY',
      age: 40,
      title: 'Platform Admin · SRE',
      team: 'IT · Platform',
      bg: 'Kakao 5년 SRE 리드 · 10년 · Postgres/pgvector/K8s/LLMOps · SOC 2 실사 대응 · Langfuse/Sentry 프로덕션 운영',
      creds:
        'AWS Solutions Architect Pro · CKA · SOC 2 Type II 대응 · Langfuse/Sentry 운영 · 21 CFR Part 11 SRE 관점',
      crossCheck:
        'pgvector 실무 · Auth.js RBAC 클레임 확장 · Inngest 크론 조율 · GitHub App 설치 방식 SSH deploy key 실무',
      evaluationScope: [
        'admin/전체',
        'admin/corpus',
        'admin/datastores',
      ...
      redLines: [
        'audit_log가 append-only DB 제약 없이 배포되면 안됨',
        '재인덱싱 크론이 겹쳐 DB 부하 초과 시 배포 차단',
        'SSO 세션 관리에 페르소나 클레임 없이 RBAC 배선 안 함',
      ],
      ...
      literacy: 'high',
      quote:
        '"Git 코퍼스와 DB를 분리한 IA 덕분에 재인덱싱 폭풍이 사라졌고, 21 CFR §11.10(e)는 hash chain으로 자동 준수된다."',
    },
  ],
  ...
  usabilityMeetings: [
    {
      id: 'M-001',
      date: '2026-07-01',
      title: 'v3 초기 페르소나 분리 · Employee/RA 2-앱',
      round: 'Design Round #1',
      status: 'closed',
      ...
      findings: [
        {
          ...
          dissent: [],
          screen: 'v2 IA',
          note: 'QMS 도메인 최상위 배치는 RA 게이트웨이 정체성 훼손 · QMS 소유는 QA팀',
        },
        {
          sev: 'positive',
          raisedBy: 'p_yuna',
          agreedBy: ['p_seojin', 'PM'],
          dissent: [],
          screen: 'Change Impact Check',
          note: '4-step 위저드가 SW 배포 판단 부담을 하루→3분으로 단축',
        },
        {
          sev: 'high',
          raisedBy: 'p_hyunjoo',
          ...
          dissent: [],
          screen: 'Employee/Ask',
          note: '규제 각주 <sup>가 비전문가에게 과다 · 간단히 보기 토글 필요',
        },
        {
          sev: 'positive',
          raisedBy: 'p_seojin',
          ...
          dissent: [],
          screen: 'RA/Inbox',
          note: '4-column Kanban 트리아지가 팀 SLA 관리에 최적 · 24h 유예 감사 위험 최소화',
        },
      ],
      decisions: [
        {
          text: '2-앱 아키텍처 채택 · Employee 5화면 + RA 6화면',
          resolution: '만장일치 (5/5)',
          promotedTo: 'BK-001',
        },
        {
          text: 'Inbox = RA 홈 · Change Impact = Employee 핵심',
          resolution: '만장일치',
          promotedTo: 'BK-002·BK-003',
        },
      ],
    ...
    },
    {
      id: 'M-002',
      date: '2026-07-01',
      title: 'Consult · Dark mode · Inbox 뷰 토글 실동작',
      round: 'Design Round #2',
      status: 'closed',
      attendees: ['PM', 'p_seojin', 'p_mina', 'p_kyu', 'p_jaehyun', 'Designer'],
      agenda: [
        'RA Consult 신설 (파워 챗)',
        'Dark mode 하드코딩 컬러 정비',
        'Inbox Kanban↔List 실동작',
      ],
      findings: [
        {
          sev: 'positive',
          raisedBy: 'p_mina',
          agreedBy: ['p_kyu', 'p_seojin'],
          dissent: [],
          screen: 'RA/Consult',
          note: '관할권 3개 병렬 비교가 엑셀 매트릭스 대체 · Knowledge 등재 원클릭',
        },
        {
          sev: 'high',
          raisedBy: 'p_mina',
          agreedBy: ['p_seojin', 'p_kyu', 'p_jaehyun'],
          dissent: [],
          screen: 'Consult 세션',
          note: '초기 구현 세션별 콘텐츠 미분리 · 어느 세션 클릭해도 같은 내용',
        },
        {
          sev: 'high',
          raisedBy: 'p_seojin',
          agreedBy: ['p_jaehyun', 'PM'],
          dissent: [],
          screen: '전 페이지 · Dark',
          note: '하드코딩 white 다수 · 사이드바 blackout · 토큰 재정비 필수',
        },
        {
          sev: 'medium',
          raisedBy: 'p_seojin',
          ...
          dissent: [],
          screen: 'RA/Inbox',
          note: 'Kanban↔List 토글이 시각 반응만 · 실제 뷰 전환 안됨',
        },
      ],
      decisions: [
        {
          text: 'Consult 5 세션 각각 실 규제 조항 딥리서치 콘텐츠 삽입',
          resolution: '만장일치 (5/5)',
          promotedTo: 'BK-004',
        },
        {
          text: '전 하드코딩 컬러 → var(--bg-surface) 토큰 치환',
          resolution: '만장일치',
          promotedTo: 'BK-005',
        },
        {
          text: 'InboxListView 신설 · view 로컬 훅으로 상태 관리',
          resolution: '만장일치',
          promotedTo: 'BK-006',
        },
      ],
      ...
      findings: [
        {
          sev: 'positive',
          raisedBy: 'p_yuna',
          agreedBy: ['p_seojin', 'p_jaehyun'],
          dissent: [],
          screen: '전역 검색',
          note: '⌘K 딥링크 강력 · 관할권 자동 필터 인식 인상적',
        },
        {
          sev: 'high',
          raisedBy: 'p_seojin',
          ...
          dissent: [],
          screen: '사이드바 하단',
          note: '사용자명 세로 clip · 창 조절 시 지속 · 원인 진단 필요',
        },
        {
          sev: 'positive',
          raisedBy: 'p_jaehyun',
          ...
          dissent: [],
          screen: 'Admin (신규)',
          note: '시스템 관리 도구 명확 격리 · 로고 그라디언트(ink→brand) 잘 표현',
        },
        {
          sev: 'high',
          raisedBy: 'p_jaehyun',
          ...
          dissent: [],
          screen: '사이드바 CSS',
          note: 'grid-template-rows 미지정으로 자식 자연 높이 초과 · 뷰포트 34px 오버플로',
        },
      ],
      decisions: [
        {
          text: 'SearchPalette 신설 · ⌘K + 3개 진입점 + 7그룹 인덱싱',
          resolution: '만장일치 (4/4)',
          promotedTo: 'BK-007',
        },
        {
          text: 'Admin 페르소나 추가 · 6화면 초기 (Overview/Users/AuditLog/RAG/Radar/Settings)',
          resolution: '만장일치',
          promotedTo: 'BK-008',
        },
        { text: '로그아웃/설정 팝오버 신설', resolution: '만장일치', promotedTo: 'BK-009' },
        {
          text: '.app-v2 grid-rows 100% + .sb2 height 100%',
          resolution: '만장일치',
          promotedTo: 'BK-010',
        },
      ],
    ...
    },
    {
      id: 'M-004',
      date: '2026-07-01',
      title: '3 Git 레포 실사 · Storage 정책 확정 (Git vs DB)',
      round: 'Design Round #4',
      status: 'closed',
      attendees: ['PM', 'p_jaehyun', 'p_seojin', 'p_mina', 'p_doyeon', 'Designer'],
      agenda: [
        'ra-llm-wiki + MD-process + ra-project 3레포 실사',
        '별도 신설 vs DB 처리 분류',
        'RAG 코퍼스 화면에 실 레포 반영',
      ],
      findings: [
        {
          sev: 'positive',
          raisedBy: 'p_jaehyun',
          agreedBy: ['p_seojin', 'p_doyeon'],
          dissent: [],
          screen: 'RAG 코퍼스',
          note: '3레포 실 연동 · 커밋 해시·브랜치·크론 표시가 감사 친화',
        },
        {
          sev: 'high',
          raisedBy: 'p_jaehyun',
          agreedBy: ['p_seojin', 'p_mina', 'PM'],
          dissent: [],
          screen: '스토리지 정책',
          note: 'Users/Products/Audit를 git으로 하면 commit 폭풍 · DB 필수',
        },
        {
          sev: 'medium',
          raisedBy: 'p_seojin',
          agreedBy: ['p_mina', 'p_jaehyun'],
          dissent: [],
          screen: '승인 답변집',
          note: 'DB 실시간 + git 야간 스냅샷 하이브리드 최적',
        },
        {
          sev: 'medium',
          raisedBy: 'p_jaehyun',
          ...
          dissent: [],
          screen: 'RAG 크론',
          note: '3레포 크론이 03:18에 몰림 · 재인덱싱 폭풍 발생',
        },
      ],
      decisions: [
        {
          text: 'RAG 코퍼스 = 3 Git 레포 (문서 원본성) · Admin 전용 관리',
          resolution: '만장일치 (5/5)',
          promotedTo: 'BK-011',
        },
        {
          text: '데이터 저장소 = DB 8종 (Users/Products/Submissions/Audit/Inbox/Answers/Assets/Embeddings)',
          resolution: '만장일치',
          promotedTo: 'BK-012',
        },
        {
          text: '승인 답변집 = Hybrid (DB + 야간 git 스냅샷 · regula-approved-answers 신설)',
          resolution: '만장일치',
          promotedTo: 'BK-013',
        },
      ],
    ...
    },
    {
      id: 'M-005',
      date: '2026-07-01',
      title: '9 페르소나 · Product Design 카테고리 · 사이드바 그룹',
      round: 'Design Round #5',
      status: 'closed',
      attendees: ['PM', 'p_seojin', 'p_bs', 'p_jaehyun', 'Designer'],
      agenda: [
        '9 페르소나 딥리서치',
        'Admin에 페르소나/사용성/백로그 카테고리 신설',
        '사이드바 그룹 분리',
      ],
      findings: [
        {
          sev: 'positive',
          raisedBy: 'p_jaehyun',
          agreedBy: ['PM', 'p_seojin'],
          dissent: [],
          screen: '데이터 저장소',
          note: 'Git/DB 분리 IA 명확 · 4 스토리지 정책 카드가 온보딩 자료로 그대로 사용 가능',
        },
        {
          sev: 'medium',
          raisedBy: 'p_seojin',
          ...
          dissent: [],
          screen: 'Admin 사이드바',
          note: '10 메뉴 flat 리스트 · 카테고리 분리 필요',
        },
        {
          sev: 'medium',
          raisedBy: 'p_seojin',
          agreedBy: ['PM'],
          dissent: [],
          screen: 'Admin 카테고리 순서',
          note: '워크스페이스→사용자→데이터→거버넌스→제품디자인 순 필요',
        },
      ],
      decisions: [
        {
          text: '9 페르소나 딥리서치 프로필 · Product Design 카테고리 신설',
          resolution: '만장일치 (4/4)',
          promotedTo: 'BK-014·BK-015',
        },
        {
          text: 'Admin 사이드바 5그룹 분리 · 순서 확정',
          resolution: '만장일치',
          promotedTo: 'BK-016·BK-017',
        },
      ],
      ...
      findings: [
        {
          sev: 'high',
          raisedBy: 'PM',
          agreedBy: ['p_seojin', 'p_mina', 'p_doyeon', 'p_hyunjoo', 'p_jaehyun'],
          dissent: [],
          screen: '판단 프로세스',
          note: '단독 의견으로는 필수/권장/기각 판단 근거 부족 · 다자 협의 결과로 재편 필요',
        },
        {
          sev: 'positive',
          raisedBy: 'p_jaehyun',
          agreedBy: ['p_seojin'],
          dissent: [],
          screen: 'Product Design',
          note: '회의록 방식이 이력 추적에 우수 · 발견 → backlog 승격 흐름 자연스러움',
        },
      ],
      decisions: [
        {
          text: 'findings 스키마: raisedBy + agreedBy + dissent 명시',
          resolution: '만장일치 (7/7)',
          promotedTo: 'BK-018',
        },
        {
          text: '분류 기준: 만장일치→필수 · 다수 지지→권장 · 임팩트 낮음→기각',
          resolution: '만장일치',
          promotedTo: 'BK-019',
        },
        {
          text: 'backlog basis 필드로 회의 + 합의 방식 명시',
          resolution: '만장일치',
          promotedTo: 'BK-020',
        },
      ],
    ...
    },
    {
      id: 'M-007',
      date: '2026-07-01',
      title: '페르소나 리뷰 매트릭스 · 세션 로그 시스템',
      round: 'Design Round #7',
      status: 'closed',
      ...
      findings: [
        {
          ...
          agreedBy: ['p_seojin', 'p_jaehyun'],
          dissent: [],
          screen: 'Usability 매트릭스',
          note: '9명 × 16화면 매트릭스 · 셀 hover로 finding 즉시 확인 가능',
        },
        {
          sev: 'high',
          raisedBy: 'PM',
          agreedBy: ['p_seojin', 'p_yuna', 'p_bs'],
          dissent: [],
          screen: '세션 실행 버튼',
          note: '이 세션에서 하는 디자인 자체가 사용성 평가 사이클임 · 코드 배포 후 활동이 아님',
        },
      ],
      decisions: [
        {
          text: 'personaReviews 매트릭스 신설 · 매 회의 후 갱신',
          resolution: '만장일치 (7/7)',
          promotedTo: 'BK-021',
        },
        {
          text: '세션 실행 = PENDING 카드로 대기열 등록 · 실 인터뷰 후 값 채움',
          resolution: '만장일치',
          promotedTo: 'BK-022',
        },
      ],
    ...
    },
    {
      id: 'M-008',
      date: '2026-07-01',
      title: '옵션 A 전면 리셋 · 페르소나 교차검증 보강 · 실 데이터 재구축',
      round: 'Design Round #8 · Reset',
      status: 'closed',
      attendees: [
        'PM',
        'p_seojin',
      ...
      findings: [
        {
          ...
          dissent: [],
          screen: '사용성 프로세스',
          note: '페르소나/사용성/백로그는 코드 배포 후 활동이 아님 · 이 대화창의 매 디자인 결정이 사이클',
        },
        {
          sev: 'positive',
          raisedBy: 'p_seojin',
          ...
          dissent: [],
          screen: '페르소나 스키마',
          note: 'crossCheck 필드로 규제 조항 인용 가능 여부 검증 · redLines로 승인 원칙 명시 · 회의 신뢰성 확보',
        },
        {
          sev: 'positive',
          raisedBy: 'p_jaehyun',
          agreedBy: ['p_seojin', 'p_mina'],
          dissent: [],
          screen: '회의 참석',
          note: '페르소나별 decisionWeight로 도메인 발언 무게 차등 · 회의 결정 근거 강화',
        },
      ],
      decisions: [
        {
          text: '전면 리셋 후 실 이력으로 재구성 (옵션 A)',
          resolution: '만장일치 (10/10)',
          promotedTo: 'BK-023',
        },
        {
          text: '페르소나 스키마 4필드 신설: crossCheck, redLines, decisionWeight, evaluationScope',
          resolution: '만장일치',
          promotedTo: 'BK-024',
        },
        {
          text: 'M-001~M-008 이 세션 실 진행 이력으로 재구성',
          resolution: '만장일치',
          promotedTo: 'BK-025',
        },
      ],
    ...
    },
    {
      id: 'M-009',
      date: '2026-07-01',
      title: '권장 백로그 우선순위 착수 · Top-4 반영',
      round: 'Design Round #9',
      status: 'closed',
      attendees: [
        'PM',
        'p_seojin',
      ...
      agenda: [
        'BK-101 간단히 보기 토글',
        'BK-104 크론 시각 분산',
        'BK-105 hash chain 자동 검증',
        'BK-103 중문/일문 hover-preview',
      ],
      findings: [
        {
          sev: 'positive',
          ...
          dissent: [],
          screen: 'Ask 답변',
          note: '"간단히 보기" 토글로 비전문가 진입 장벽 즉시 해소. 감사 대비 상세 모드 강제 정책 명확.',
        },
        {
          sev: 'positive',
          raisedBy: 'p_jaehyun',
          ...
          dissent: [],
          screen: 'RAG 코퍼스 · 크론',
          note: '3레포 크론 03:00/03:20/03:40 분산 · 재인덱싱 폭풍 해소 · SRE 부담 감소.',
        },
        {
          sev: 'positive',
          raisedBy: 'p_jaehyun',
          ...
          dissent: [],
          screen: '감사 로그',
          note: '월 1회 자동 hash chain 검증 + Slack #security-incident 알림 · 감사 준비 시간 5일→반나절.',
        },
        {
          sev: 'positive',
          raisedBy: 'p_kyu',
          agreedBy: ['p_mina', 'p_seojin'],
          dissent: [],
          screen: 'Consult · Radar',
          note: '중문/일문 원문 hover-preview + 클립보드 복사로 심사관 대응 정확도 향상.',
        },
      ],
      decisions: [
        {
          text: 'BK-101/104/105/103 → 필수 승격 · 즉시 반영',
          resolution: '만장일치 (8/8)',
          promotedTo: 'BK-026·027·028·029',
        },
      ],
    ...
    },
    {
      id: 'M-010',
      date: '2026-07-01',
      title: 'BK-102 기각 · 남은 권장 3건 분석',
      round: 'Design Round #10',
      status: 'closed',
      ...
      findings: [
        {
          ...
          dissent: [],
          screen: 'BK-102',
          note: '사내 Slack 미사용 · Slack 봇 자동 요약 근거 소실 · 커뮤니케이션 채널 확인 필요',
        },
      ],
      decisions: [
        {
          text: 'BK-102 기각 · 사내 커뮤니케이션 채널 확인 후 재상정',
          resolution: '만장일치 (4/4)',
        },
      ],
    ...
    },
    {
      id: 'M-011',
      date: '2026-07-01',
      title: 'BK-108 기각 · 감지는 사내 시스템 통합 필요',
      round: 'Design Round #11',
      status: 'closed',
      ...
      findings: [
        {
          sev: 'high',
          raisedBy: 'PM',
          agreedBy: ['p_jaehyun', 'p_doyeon'],
          dissent: [],
          screen: 'BK-108',
          note: 'Regula는 사내 PLM/QMS/DMS를 감시하지 않음 · webhook 없으면 감지 자체 불가 · "감지"는 오해 유발',
        },
      ],
      decisions: [
        {
          text: 'BK-108 기각 · 사내 PLM/QMS 시스템 확인 후 통합 별도 트랙',
          resolution: '만장일치 (4/4)',
        },
      ],
    ...
    },
    {
      id: 'M-012',
      date: '2026-07-01',
      title: '권장 남은 2건 필수 승격 · BK-106 · BK-107',
      round: 'Design Round #12',
      status: 'closed',
      attendees: ['PM', 'p_seojin', 'p_jihun', 'p_kyu', 'p_doyeon', 'Designer'],
      agenda: [
        'BK-106 도메인 용어 Autocomplete 최종 검토',
        'BK-107 시장별 재시험 매트릭스 최종 검토',
      ],
      findings: [
        {
          sev: 'positive',
          raisedBy: 'p_jihun',
          agreedBy: ['p_seojin', 'p_kyu'],
          dissent: [],
          screen: 'BK-107 매트릭스',
          note: 'CN GB 9706 강화 조항 매핑이 IEC 60601 대비 명확 · 재시험 판단 즉시 가능',
        },
        {
          sev: 'positive',
          raisedBy: 'p_doyeon',
          agreedBy: ['p_seojin'],
          dissent: [],
          screen: 'BK-106 Autocomplete',
          note: '30개 초기 용어 사전이 SOP 링크까지 이어져 문서 감사 준비 부담 감소',
        },
      ],
      decisions: [
        {
          text: 'BK-106 · BK-107 필수 승격 · 즉시 반영',
          resolution: '만장일치 (5/5)',
          promotedTo: 'BK-030·031',
        },
      ],
    ...
    },
    {
      id: 'M-013',
      date: '2026-07-01',
      title: '담당 제품 개념 폐기 · 개인화 제거',
      round: 'Design Round #13',
      status: 'closed',
      ...
      findings: [
        {
          sev: 'high',
          raisedBy: 'PM',
          agreedBy: ['p_doyeon', 'p_hyunjoo'],
          dissent: [],
          screen: 'Employee/제품 카드',
          note: '개인화 없이 모든 Employee가 전 제품 자유 조회 · 담당 배정은 조직 변경 관리 부담',
        },
      ],
      decisions: [
        {
          text: 'Employee "담당 제품" 개념 완전 폐기 (옵션 C)',
          resolution: '만장일치 (5/5)',
          promotedTo: 'BK-032',
        },
      ],
      followups: [
        'users.employee.products 제거',
        'EmpProducts scope 로직 삭제',
        '사이드바 라벨 "내 제품 규제 카드" → "제품 규제 카드"',
      ],
    },
    {
      id: 'M-014',
      date: '2026-07-01',
      title: 'ra-llm-wiki가 제품 · 사례 SOR · 아키텍처 재정의',
      round: 'Design Round #14',
      status: 'closed',
      attendees: ['PM', 'p_seojin', 'p_jaehyun', 'p_doyeon', 'p_jihun', 'Designer'],
      agenda: [
        'ra-llm-wiki를 제품 인벤토리 소스로 재정의',
        'Change Impact 계층 4 = 유사 사례 RAG 조회',
        'Admin > Products 편집 UI',
      ],
      findings: [
        {
          sev: 'high',
          raisedBy: 'PM',
          agreedBy: ['p_jaehyun', 'p_seojin', 'p_doyeon'],
          dissent: [],
          screen: '아키텍처',
          note: 'ra-llm-wiki(NAS 인제스트)를 규제 답변용으로만 봤음 · 실은 사내 데이터 SOR · 제품 · 사례 · 인증 이력의 원천',
        },
        {
          sev: 'positive',
          raisedBy: 'p_seojin',
          ...
          note: '유사 변경 사례 RAG 조회가 판정 신뢰도의 결정적 증거 · "과거 이렇게 판정했음" 근거 제공',
        },
        {
          sev: 'positive',
          raisedBy: 'p_jaehyun',
          ...
          dissent: [],
          screen: '데이터 파이프라인',
          note: 'ra-llm-wiki 인제스트 훅에 제품 메타 추출 스텝 추가 · LLM으로 STED 파싱 · 매 크론마다 자동 갱신',
        },
      ],
      decisions: [
        {
          text: '제품 카드 데이터 = ra-llm-wiki 자동 추출 + LLM 파싱',
          resolution: '만장일치 (5/5)',
          promotedTo: 'BK-033',
        },
        {
          text: 'Change Impact 계층 4 = ra-llm-wiki에서 유사 사례 RAG 조회',
          resolution: '만장일치',
          promotedTo: 'BK-034',
        },
        {
          text: 'Admin > Products 편집 UI = 자동 추출 검증·override',
          resolution: '만장일치',
          promotedTo: 'BK-035',
        },
      ],
  ...
  backlog: [
    ...
    {
      id: 'BK-033',
      title: '제품 카드 데이터 = ra-llm-wiki 자동 추출',
      kind: 'essential',
      status: 'resolved',
      mtg: 'M-014',
      basis: '만장일치 (5/5)',
    ...
    {
      id: 'BK-034',
      title: 'Change Impact 계층 4 = 유사 사례 RAG',
      kind: 'essential',
      status: 'resolved',
      mtg: 'M-014',
      basis: '만장일치',
    ...
    {
      id: 'BK-032',
      title: 'Employee "담당 제품" 개념 폐기 (옵션 C)',
      kind: 'essential',
      status: 'resolved',
      mtg: 'M-013',
      basis: '만장일치 (5/5)',
    ...
    {
      id: 'BK-001',
      title: '2-앱 아키텍처 (Employee 5 + RA 6화면)',
      kind: 'essential',
      status: 'resolved',
      mtg: 'M-001',
      basis: '만장일치 (5/5)',
    ...
    {
      id: 'BK-002',
      title: 'RA Inbox 4-column Kanban 트리아지',
      kind: 'essential',
      status: 'resolved',
      mtg: 'M-001',
      basis: '만장일치',
    ...
    {
      id: 'BK-003',
      title: 'Employee Change Impact Check 위저드',
      kind: 'essential',
      status: 'resolved',
      mtg: 'M-001',
      basis: '만장일치',
    ...
    {
      id: 'BK-004',
      title: 'RA Consult 5 세션 딥리서치 콘텐츠',
      kind: 'essential',
      status: 'resolved',
      mtg: 'M-002',
      basis: '만장일치 (5/5)',
    ...
    {
      id: 'BK-007',
      title: '전역 검색 팔레트 (SearchPalette · ⌘K)',
      kind: 'essential',
      status: 'resolved',
      mtg: 'M-003',
      basis: '만장일치 (4/4)',
    ...
    {
      id: 'BK-010',
      title: '사이드바 세로 clip 수정 (grid-rows 100%)',
      kind: 'essential',
      status: 'resolved',
      mtg: 'M-003',
      basis: '만장일치',
    ...
    {
      id: 'BK-011',
      title: 'RAG 코퍼스 = Git 3레포 방식 (Admin 전용)',
      kind: 'essential',
      status: 'resolved',
      mtg: 'M-004',
      basis: '만장일치 (5/5)',
    ...
    {
      id: 'BK-013',
      title: '승인 답변집 Hybrid (DB + 야간 git 스냅샷)',
      kind: 'essential',
      status: 'resolved',
      mtg: 'M-004',
      basis: '만장일치',
    ...
    {
      id: 'BK-015',
      title: 'Product Design 카테고리 신설 (Admin)',
      kind: 'essential',
      status: 'resolved',
      mtg: 'M-005',
      basis: '만장일치',
    ...
    {
      id: 'BK-019',
      title: '분류 기준: 만장일치→필수 · 다수→권장 · 낮음→기각',
      kind: 'essential',
      status: 'resolved',
      mtg: 'M-006',
      basis: '만장일치',
    ...
    {
      id: 'BK-020',
      title: 'backlog basis 필드로 회의·합의 방식 명시',
      kind: 'essential',
      status: 'resolved',
      mtg: 'M-006',
      basis: '만장일치',
    ...
    {
      id: 'BK-021',
      title: 'personaReviews 매트릭스 (9 × 16)',
      kind: 'essential',
      status: 'resolved',
      mtg: 'M-007',
      basis: '만장일치 (7/7)',
    ...
    {
      id: 'BK-025',
      title: '회의록 M-001~M-008 실 이력 재구성',
      kind: 'essential',
      status: 'resolved',
      mtg: 'M-008',
      basis: '만장일치',
    ...
    {
      id: 'BK-101',
      title: 'Employee/Ask · "간단히 보기" 각주 토글',
      kind: 'essential',
      status: 'resolved',
      mtg: 'M-009',
      basis: '만장일치 (8/8) · M-001 최초 발제',
      desc: '비전문가에게 <sup> 축약 · hover로만 규제 인용 노출 · 감사 시 상세 모드 강제',
      resolvedAt: 'M-009 반영 · Employee/Ask 토글 배선',
    },
    {
      id: 'BK-102',
      title: 'Consult 세션 · Slack #ra-consult 자동 요약',
      kind: 'rejected',
      status: 'rejected',
      mtg: 'M-010',
      basis: 'PM 반대 · 전원 동의',
    ...
    {
      id: 'BK-105',
      title: 'audit_log hash chain 자동 검증 + Slack 알림',
      kind: 'essential',
      status: 'resolved',
      mtg: 'M-009',
      basis: '만장일치 · M-004 최초 발제',
    ...
    },
    {
      ...
      rejectReason:
        '"감지"는 사내 PLM/QMS webhook 통합 필요 · Regula 단독 구현 불가 · 판정 자동화만 가능한데 이는 BK-108-A 별도 항목',
    },

    // ── 기각 (rejected) · 사유 명시 ─────────────────────
    {
      id: 'BK-201',
      title: 'v2 QMS 도메인 (CAPA/CC/Audit/PMS) 유지',
      kind: 'rejected',
      status: 'rejected',
      mtg: 'M-001',
      basis: 'p_seojin 반대 · PM 지지',
      desc: 'CAPA/Change Control/Audit/PMS 워크벤치를 Regula 내부에 유지',
      rejectReason: 'QMS 도메인 소유는 QA팀 · Regula는 RA 게이트웨이 정체성 유지 필수',
    },
    {
      id: 'BK-202',
      title: 'CER 워크벤치 직접 연결',
      kind: 'rejected',
      status: 'rejected',
      mtg: 'M-002',
      basis: 'p_seojin 반대 · p_bs 부분 지지',
      desc: 'Consult 답변에서 CER 특정 섹션 자동 초안 생성',
      rejectReason: 'CER = QMS 소유 도메인 · Regula 범위 이탈',
    },
    {
      id: 'BK-203',
      title: '답변에 시각자료(도해) 자동 첨부',
      kind: 'rejected',
      status: 'rejected',
      mtg: 'M-005',
      basis: 'p_bs 제안 · 다수 유예',
    ...
    },
    {
      ...
      rejectReason:
        '디자인 변경 없이 성숙도 지표가 움직이면 프로젝트 왜곡 · PENDING으로 정직 표기 (BK-022)',
    },
    {
      id: 'BK-205',
      title: '단독 페르소나 발제로 필수 backlog 승격',
      kind: 'rejected',
      status: 'rejected',
      mtg: 'M-006',
      basis: 'p_seojin 반대 · 전원 동의',
    ...
    'employee/ask': [
      {
        persona: 'p_yuna',
        score: 4,
        finding: '자연어 입력 낮은 부담. 파워 유저용 슬래시 명령 자동완성 있으면 5점.',
        action: 'BK-106 도메인 용어 autocomplete와 연계',
      },
      {
        persona: 'p_jihun',
        score: 3,
        finding: 'BOM/EMC 축약어 인식 부재. HW 첫 질문 학습 곡선.',
        action: 'BK-106',
      },
      {
        persona: 'p_hyunjoo',
        score: 3,
        finding: '비전문가 톤 좋음. 각주 과다로 이해 방해.',
        action: 'BK-101 간단히 보기 토글',
      },
      {
        persona: 'p_doyeon',
        score: 4,
        finding: '3분 내 답변 만족. SOP 인용 링크 우수.',
        action: '',
      },
    ],
    'employee/myqs': [
      {
        persona: 'p_yuna',
        score: 4,
        finding: 'SLA 배지 명확. 실시간 카운트다운 있으면 5점.',
        action: '카운트다운 (v3.1)',
      },
      {
        persona: 'p_hyunjoo',
        score: 3,
        finding: '"답변 완료"만으로 인용 가능 여부 판단 불가. 신뢰 태그 필요.',
        action: '신뢰 태그 (v3.1)',
      },
      {
        persona: 'p_bs',
        score: 4,
        finding: '질의 이력 축적 UX 만족. 첨부 지원 없음.',
        action: '첨부 (v3.2)',
      },
    ],
    'employee/products': [
      {
        persona: 'p_jihun',
        score: 3,
        finding: '시장별 상태 우수. 국가별 시험 재활용 매트릭스 없음.',
        action: 'BK-107',
      },
      {
        persona: 'p_doyeon',
        score: 4,
        finding: 'UDI 상태 표기 우수. 갱신 트리거 자동 감지 시 5점.',
        action: 'BK-108',
      },
      {
        persona: 'p_seojin',
        score: 5,
        finding: '팀 대시보드로 활용 가능. 담당 제품 한 화면 확인.',
        action: '',
      },
    ],
    'employee/guides': [
      {
        persona: 'p_doyeon',
        score: 3,
        finding: '조회수 정렬만. 최근 갱신·부서 필터 요청.',
        action: 'Guides 필터 (v3.1)',
      },
      {
        persona: 'p_hyunjoo',
        score: 4,
        finding: '카테고리 필터 직관. 신 규제 후 자동 가이드 초안 있으면 완벽.',
        action: '자동 가이드 (v3.2)',
      },
    ],
    'employee/impact': [
      {
        persona: 'p_yuna',
        score: 5,
        finding: 'SW 변경 판단 3분 완료. 하루 반나절 절감.',
        action: '',
      },
      {
        persona: 'p_jihun',
        score: 4,
        finding: 'HW BOM 변경도 커버. 시장별 재시험 연계 시 완벽.',
        action: 'BK-107 연계',
      },
      {
        persona: 'p_bs',
        score: 3,
        finding: '임상 확장은 위저드 4단계 부족. 별도 임상 트랙 필요.',
        action: '임상 트랙 (v3.2)',
      },
    ],
    'ra/inbox': [
      {
        persona: 'p_seojin',
        score: 5,
        finding: '4-column Kanban 팀 SLA 관리에 최적. 24h 유예 감사 위험 최소화.',
        action: '',
      },
      {
        persona: 'p_mina',
        score: 4,
        finding: 'Global RA로 언어 필터 있으면 5점.',
        action: '언어 필터 (v3.1)',
      },
      {
        persona: 'p_kyu',
        score: 4,
        finding: 'APAC 담당 지역 필터 기본 지원 시 5점.',
        action: '지역 필터 (v3.1)',
      },
    ],
    'ra/consult': [
      {
        persona: 'p_mina',
        score: 5,
        finding: '관할권 3개 병렬 비교가 엑셀 대체. Knowledge 등재 원클릭.',
        action: '',
      },
      {
        persona: 'p_seojin',
        score: 4,
        finding: '팀 리드로 세션 공유 필요. Slack 자동 요약이 있으면 완벽.',
        action: 'BK-102',
      },
      {
        persona: 'p_kyu',
        score: 4,
        finding: '중문/일문 원문 hover-preview 필요.',
        action: 'BK-103',
      },
    ],
    'ra/submissions': [
      {
        persona: 'p_seojin',
        score: 4,
        finding: '진행 상태 매트릭스 우수. NB deficiency 히스토리 붙으면 완벽.',
        action: 'NB 히스토리 (v3.2)',
      },
      {
        persona: 'p_kyu',
        score: 3,
        finding: 'NMPA 14단계 표시 좋음. CFDI 서식 다운로드 부재.',
        action: 'CFDI 서식 링크 (v3.1)',
      },
      {
        persona: 'p_mina',
        score: 4,
        finding: 'MDR+FDA 이중 제출 문서 재활용 표기 우수.',
        action: '',
      },
    ],
    'ra/registry': [
      {
        persona: 'p_seojin',
        score: 5,
        finding: '제품 × 시장 매트릭스 임원 보고 그대로 사용. CSV 내보내기 우수.',
        action: '',
      },
      {
        persona: 'p_mina',
        score: 4,
        finding: 'Global 관점 3지역 상태 한눈에 확인. 관할권 필터 있으면 5점.',
        action: '관할권 필터 (v3.1)',
      },
    ],
    'ra/radar': [
      {
        persona: 'p_kyu',
        score: 3,
        finding: '중문/일문 원문 자동번역만. Hover-preview 필요.',
        action: 'BK-103',
      },
      {
        persona: 'p_mina',
        score: 4,
        finding: '사내 임팩트 평가 자동화 우수. 심각도 상승 시 자동 알림 필요.',
        action: '자동 알림 (v3.1)',
      },
      {
        persona: 'p_yuna',
        score: 4,
        finding: 'SW 관련 신 규제(PCCP/GMLP) 자동 태그 우수.',
        action: '',
      },
    ],
    'ra/knowledge': [
      {
        persona: 'p_seojin',
        score: 4,
        finding: 'KPI 4개 팀 리뷰에 즉시 사용. Deprecated 재검토 트리거 필요.',
        action: '재검토 트리거 (v3.1)',
      },
      {
        persona: 'p_doyeon',
        score: 4,
        finding: '활용도 순위 우수. 답변 개정 이력이 git blame으로 이어지면 감사 준비 부담 감소.',
        action: 'Git blame UI (v3.2)',
      },
    ],
    'admin/overview': [
      {
        persona: 'p_jaehyun',
        score: 4,
        finding: 'KPI + 시스템 상태 헬스 우수. 실시간 metric 스트림 없음.',
        action: '실시간 metric (v3.2)',
      },
    ],
    'admin/users': [
      {
        persona: 'p_jaehyun',
        score: 4,
        finding: 'RBAC 5역할 명확. SSO 클레임 매핑 UI 부재.',
        action: 'SSO 클레임 매핑 (v3.1)',
      },
      {
        persona: 'p_seojin',
        score: 4,
        finding: '팀 사용자 관리 우수. 감사 관점 last login 시각 표시 좋음.',
        action: '',
      },
    ],
    'admin/corpus': [
      {
        persona: 'p_jaehyun',
        score: 5,
        finding: 'Git 커밋 해시·브랜치·크론 감사 친화. 크론 시각 분산만 하면 완벽.',
        action: 'BK-104',
      },
      {
        persona: 'p_doyeon',
        score: 5,
        finding: '사내 SOP 레포 연동으로 감사 요건 자동 충족.',
        action: '',
      },
    ],
    'admin/datastores': [
      {
        persona: 'p_jaehyun',
        score: 5,
        finding: 'Git/DB 분리 IA 명확. 4 스토리지 정책 카드 온보딩 자료로 활용.',
        action: '',
      },
    ],
    'admin/logs': [
      {
        persona: 'p_jaehyun',
        score: 4,
        finding: 'SHA-256 hash chain 표기 우수. 자동 검증 + Slack 알림 시 5점.',
        action: 'BK-105',
      },
      {
        persona: 'p_seojin',
        score: 5,
        finding: '감사 준비 시 그대로 export 가능. append-only DB 제약 명시적.',
        action: '',
      },
    ],
    'admin/settings': [
      {
        persona: 'p_jaehyun',
        score: 4,
        finding: '5 정책 그룹 명확. 변경 시 audit_log 자동 기록 필요.',
        action: 'audit 자동 기록 (v3.2)',
      },
    ],
    'admin/personas': [
      {
        persona: 'p_jaehyun',
        score: 5,
        finding: '9 페르소나 crossCheck/redLines 필드로 신뢰성 확보.',
        action: '',
      },
      {
        persona: 'p_seojin',
        score: 5,
        finding: '팀 리드로 각 페르소나 발언 무게 판단 근거 명확.',
        action: '',
      },
    ],
    'admin/usability': [
      {
        persona: 'p_seojin',
        score: 5,
        finding: '회의록 이력 · 페르소나 매트릭스 통합 뷰. 단독 vs 다자 협의 시각적 구분.',
        action: '',
      },
      {
        persona: 'p_jaehyun',
        score: 4,
        finding: '평가 세션 PENDING 정직 표기. 실 인터뷰 없이 성숙도 왜곡 방지.',
        action: '',
      },
    ],
    'admin/backlog': [
      {
        persona: 'p_seojin',
        score: 5,
        finding: '필수/권장/기각 3분류 명확. basis 필드로 회의 링크 감사 가능.',
        action: '',
      },
      {
        persona: 'p_jaehyun',
        score: 4,
        finding: '기각 사유 명시로 재제안 시 판단 근거 유지.',
        action: '',
      },
    ],
  },
  ...
  reviewSessions: [
    ...
    },
    {
      id: 'S-2026-02',
      date: '2026-07-01',
      scope: 'Consult + Dark mode 정비 (Round #2)',
      personas: 5,
      screens: 4,
      avgScore: 3.8,
      findings: 4,
    ...
    },
    {
      id: 'S-2026-03',
      date: '2026-07-01',
      scope: '검색 팔레트 + 3-tier Admin (Round #3)',
      personas: 4,
      screens: 4,
      avgScore: 4.0,
      findings: 4,
    ...
    },
    {
      id: 'S-2026-04',
      date: '2026-07-01',
      scope: '3 Git 레포 + Storage 정책 (Round #4)',
      personas: 5,
      screens: 4,
      avgScore: 4.2,
      findings: 4,
    ...
    },
    {
      id: 'S-2026-05',
      date: '2026-07-01',
      scope: '9 페르소나 · Product Design (Round #5)',
      personas: 4,
      screens: 3,
      avgScore: 4.3,
      findings: 3,
    ...
    },
    {
      id: 'S-2026-06',
      date: '2026-07-01',
      scope: '실 데이터 전환 · 다자 협의 스키마 (Round #6)',
      personas: 7,
      screens: 2,
      avgScore: 4.4,
      findings: 2,
    ...
    },
    {
      id: 'S-2026-07',
      date: '2026-07-01',
      scope: 'personaReviews 매트릭스 (Round #7)',
      personas: 7,
      screens: 2,
      avgScore: 4.5,
      findings: 2,
  ...
  originalPreviews: {
    ...
    'pmda-type2': {
      ...
      translation:
        'Type-II 대면조언은 PMD Act에 근거하여 의료기기 개발·승인 신청 등에 관해 PMDA와 대면 상담하는 제도. 특히 Class II (第二種医療機器) 신규 신청 전, 시험 타당성·임상평가 전략 확인에 유효.',
    },
    'pmda-jmdn': {
      ...
      translation:
        'JMDN 46001010 뇌파계. 지정관리의료기기 (Class II). 관리의료기기 중 적절한 사용을 위한 조치가 제정된 품목. 제3자 인증기관(RCB) 인증 또는 PMDA 승인 중 하나가 필요.',
    },
    'mfds-cyber-2025': {
      ...
      translation:
        'SW 기반 의료기기 및 SaMD 인허가 신청 시 SBOM 필수 제출 · CycloneDX / SPDX 형식 · 오픈소스 + 상용 SW 모두 포함.',
    },
  },
  ...
  domainTerms: [
    // 규제 프레임워크
    {
      ...
      cat: '품질',
      def: '자재/부품 목록',
      regs: ['ISO 13485 §7.5.9'],
      sop: 'MD-process/DCN-001',
    },
    {
      term: 'CBOM',
      full: 'Cybersecurity Bill of Materials',
      cat: '보안',
      def: '사이버보안 자산 목록',
      regs: ['FDA CSF 2023', 'MFDS 2025-01'],
      sop: '',
    },
    {
      term: 'SBOM',
      ...
      cat: '소프트웨어',
      def: '소프트웨어 구성요소 목록',
      regs: ['MFDS 2025-01 §7', 'FDA Refuse-to-Accept'],
      sop: 'MD-process/SW-002',
    },
    {
      term: 'SOUP',
      full: 'Software of Unknown Provenance',
      cat: '소프트웨어',
      def: '출처 불명 소프트웨어 (오픈소스 포함)',
      regs: ['IEC 62304 §5.3.3', '§7.1.2'],
      sop: 'MD-process/SW-003',
    },
    {
      term: 'PCCP',
      full: 'Predetermined Change Control Plan',
      cat: 'AI/SW',
      def: 'AI/ML 재학습 사전 승인 계획',
      regs: ['FDA 2024-12 Final', 'MDCG 2024-9'],
      sop: '',
    },
    {
      term: 'EMC',
      ...
      cat: 'HW',
      def: '전자파 적합성',
      regs: ['IEC 60601-1-2:2020'],
      sop: 'MD-process/HW-005',
    },
    {
      term: 'EMI',
    ...
    },
    {
      ...
      cat: 'HW',
      def: '외부 방해에 대한 내성',
      regs: ['IEC 60601-1-2 §8.7'],
      sop: '',
    },
    {
      term: 'UDI',
      full: 'Unique Device Identifier',
      cat: '라벨',
      def: '의료기기 고유 식별자',
      regs: ['MDR Art. 27', '21 CFR §801.20'],
      sop: 'MD-process/UDI-001',
    },
    {
      term: 'UDI-DI',
      full: 'UDI Device Identifier',
      cat: '라벨',
      def: '모델 식별 코드 (변경 시 재발급)',
      regs: ['MDR Art. 27(1)'],
      sop: '',
    },
    {
      term: 'UDI-PI',
      full: 'UDI Production Identifier',
      cat: '라벨',
      def: '로트/일련번호 식별',
      regs: ['MDR Art. 27(4)'],
      sop: '',
    ...
    {
      term: 'STED',
      full: 'Summary Technical Documentation',
      cat: '기술문서',
      def: '기술문서 요약 (GHTF 포맷)',
      regs: ['GHTF/SG1/N011:2008'],
      sop: 'ra-project/STED',
    },
    {
      term: 'MDCG',
      full: 'Medical Device Coordination Group',
      cat: '규제',
      def: 'EU MDR/IVDR 조정 그룹',
      regs: ['MDR Art. 103'],
      sop: '',
    },
    {
      term: 'RCB',
      full: 'Registered Certification Body',
      cat: 'JP',
      def: 'PMDA 지정 제3자 인증기관',
      regs: ['PMD Act §23-2-23'],
      sop: '',
    },
    {
      term: 'DMAH',
      full: 'Designated Marketing Authorization Holder',
      cat: 'JP',
      def: '외국제조업자 지정관리자 (일본)',
      regs: ['PMD Act §19-2'],
      sop: '',
    ...
    {
      term: 'PMCF',
      full: 'Post-Market Clinical Follow-up',
      cat: '임상',
      def: '시판 후 임상 후속조사',
      regs: ['MDR Annex XIV Part B'],
      sop: 'MD-process/CLIN-002',
    },
    {
      term: 'CIP',
      ...
      cat: '임상',
      def: '임상시험 계획서',
      regs: ['ISO 14155 §7.3', 'MDR Annex XV'],
      sop: '',
    },
    {
      term: 'CER',
      full: 'Clinical Evaluation Report',
      cat: '임상',
      def: '임상평가 보고서',
      regs: ['MDR Art. 61', 'MEDDEV 2.7/1 r4'],
      sop: '',
    },
    {
      term: 'PSUR',
    ...
    },
    {
      ...
      full: 'GB 9706.1-2020',
      cat: 'CN',
      def: 'IEC 60601-1 대비 강화된 중국 표준',
      regs: ['NMPA GB 9706 시리즈'],
      sop: '',
    },
    {
      term: 'JMDN',
      full: 'Japanese Medical Device Nomenclature',
      cat: 'JP',
      def: '일본 의료기기 분류코드 (7자리)',
      regs: ['PMDA'],
      sop: '',
    },
    {
      term: 'DCN',
      full: 'Design Change Notice',
      cat: '품질',
      def: '설계 변경 통지',
      regs: ['ISO 13485 §7.3.9'],
      sop: 'MD-process/DCN-001',
    },
    {
      term: 'CAPA',
      ...
      cat: '품질',
      def: '시정 및 예방 조치',
      regs: ['ISO 13485 §8.5.2/§8.5.3', '21 CFR §820.100'],
      sop: 'MD-process/CAPA-001',
    },
    {
      term: 'GMLP',
      full: 'Good Machine Learning Practice',
      cat: 'AI',
      def: 'FDA 우수 머신러닝 실무 원칙',
      regs: ['FDA/Health Canada/MHRA 2021'],
      sop: '',
    },
    {
      term: 'SaMD',
      ...
      def: '독립 소프트웨어 의료기기',
      regs: ['IMDRF N12', 'FDA'],
      sop: 'MD-process/SW-001',
    },
    {
      term: 'Predicate',
      full: 'Predicate Device',
      cat: 'FDA',
      def: '510(k) 실질적 동등성 대상 기기',
      regs: ['21 CFR §807.92'],
      sop: '',
    },
    {
      term: 'RTA',
      full: 'Refuse-to-Accept',
      cat: 'FDA',
      def: 'FDA 접수 거부 체크리스트',
      regs: ['FDA RTA Guidance 2026'],
      sop: '',
    },
    {
      term: 'MDR',
      full: 'Medical Device Regulation (EU) 2017/745',
      cat: 'EU',
      def: 'EU 의료기기 규정',
      regs: ['(EU) 2017/745'],
      sop: '',
    ...
    {
      term: 'IVDR',
      full: 'In Vitro Diagnostic Regulation (EU) 2017/746',
      cat: 'EU',
      def: 'EU 체외진단 규정',
      regs: ['(EU) 2017/746'],
      sop: '',
  ...
  retestMatrix: {
    ...
    cells: {
      ...
      'bom-cn': {
        level: 'required',
        ref: 'GB 9706.1-2020 §7.9.2',
        note: '누설전류 강화 조항 · IEC 대비 10배 엄격 · CMDE 재시험',
      },
      'bom-jp': {
        level: 'conditional',
        ref: 'PMD Act 一部変更',
        note: '軽微변경 신고 or 제조판매 승인 갱신 판단',
      },

      'sw-us': {
        level: 'conditional',
        ref: 'FDA PCCP 2024-12',
        note: 'PCCP 등록되어 있으면 자동 승인 · 없으면 Special 510(k)',
      },
      'sw-eu': {
        level: 'required',
        ref: 'MDR Art. 10(9), MDCG 2024-9',
        note: 'CIP 없으면 TR 개정 필수',
      },
      'sw-kr': {
        level: 'conditional',
        ref: 'MFDS SaMD 변경허가 v2.0',
        note: '경미변경 vs 변경허가 판단',
      },
      'sw-cn': { level: 'required', ref: 'NMPA SaMD 分类界定', note: '변경 카테고리별 서식 별도' },
      'sw-jp': {
        level: 'required',
        ref: 'PMD Act §23-2-15',
        note: '一部変更承認 or Todokede 갱신',
      },

      'sw-minor-us': {
        level: 'not-required',
        ref: 'FDA Change Guidance',
        note: 'Letter to File · 문서 보관',
      },
      'sw-minor-eu': {
        level: 'conditional',
        ref: 'MDCG 2024-9 §5.2',
        note: 'Significant change 판단 · 대체로 skip',
      },
      ...
      'label-eu': {
        level: 'conditional',
        ref: 'MDR Art. 27',
        note: 'UDI-DI 갱신 · EUDAMED 재등록',
      },
      'label-kr': { level: 'conditional', ref: 'MFDS 표시 규정', note: 'UDI-DI 갱신' },
      'label-cn': {
        level: 'conditional',
        ref: 'NMPA UDI 규정 (2019)',
        note: 'UDI-DI + CFDA 라벨 승인',
      },
      'label-jp': { level: 'conditional', ref: 'PMDA · JMDN', note: '添付文書 개정' },

      'warn-us': {
        level: 'required',
        ref: 'FDA Special 510(k)',
        note: 'Warning 변경은 항상 재제출',
      },
      'warn-eu': {
        level: 'required',
        ref: 'MDR Art. 27 §4',
        note: 'UDI-DI 재발급 필수 · IFU 개정',
      },
      ...
      'process-us': {
        level: 'conditional',
        ref: 'FDA §807.81(a)(3)',
        note: 'Manufacturing change · Special 510(k) 판단',
      },
      'process-eu': {
        level: 'required',
        ref: 'MDR Art. 120, ISO 13485',
        note: 'NB 감사 · 공정검증 재수행',
      },
      ...
      'process-cn': {
        level: 'required',
        ref: 'NMPA 생산허가',
        note: '생산공정 변경신고 · 현장 재감사',
      },
      'process-jp': { level: 'required', ref: 'PMD Act QMS', note: 'MHLW 시행령 169호 재감사' },

      'sterile-us': {
        level: 'required',
        ref: 'FDA ISO 11135 recognition',
        note: 'Sterilization validation 재수행',
      },
      'sterile-eu': {
        level: 'required',
        ref: 'MDR Annex I §11',
        note: 'Notified Body sterile process 재감사',
      },
      'sterile-kr': {
        level: 'required',
        ref: 'MFDS 멸균 가이드',
        note: '멸균 밸리데이션 재수행 · 성적서',
      },
      'sterile-cn': {
        level: 'required',
        ref: 'NMPA + YY/T 0287',
        note: 'GB/YY 표준 · CMDE 재시험',
      },
      'sterile-jp': {
        level: 'required',
        ref: 'PMDA/MHLW ISO 11135',
        note: 'Sterile 밸리데이션 재수행',
      },
    },
  },
  ...
  radarSources: [
    ...
    {
      id: 's-mfds-rss',
      name: 'MFDS 의료기기 고시 · 공고',
      url: 'https://mfds.go.kr/rss',
      freq: '6h',
      enabled: true,
      lastRun: '2026-06-30 22:00',
      items: 3,
      warn: '지연 발생',
    },
    {
      id: 's-nmpa-scrp',
      name: 'NMPA 公告 (scraper)',
      url: 'https://www.nmpa.gov.cn',
      freq: '12h',
      enabled: true,
      lastRun: '2026-07-01 04:00',
      items: 1,
    },
    {
      id: 's-pmda-rss',
      name: 'PMDA お知らせ',
      url: 'https://www.pmda.go.jp/rss',
      freq: '12h',
      enabled: true,
      lastRun: '2026-07-01 04:00',
      items: 0,
    ...
    {
      id: 's-imdrf-scrp',
      name: 'IMDRF Working Group publications',
      url: 'https://www.imdrf.org',
      freq: 'daily',
      enabled: false,
      lastRun: '2026-06-15 00:00',
      items: 0,
    },
    {
      id: 's-iso-scrp',
      name: 'ISO/IEC 신규 표준 게시',
    ...
    {
      id: 's-tuvsud',
      name: 'TÜV SÜD White Papers',
      url: 'https://www.tuvsud.com',
      freq: 'daily',
      enabled: true,
      lastRun: '2026-07-01 03:00',
      items: 1,
    },
  ],
  ...
  adminSettings: {
    sla: [
      {
        key: 'auto',
        lbl: '자동 답변 유예 (RA 감사 대기)',
        val: '24h',
        desc: '자동 발송 후 RA가 취소 가능한 시간창',
      },
      {
        key: 'needs-review',
        lbl: '검토 필요 응답 SLA',
        val: '12h',
        desc: '이전 24h → 12h로 단축됨 (2026-06-30 수정)',
      },
    ...
    triage: [
      ...
      },
      {
        ...
        lbl: '검토 필요 하한',
        val: '60%',
        desc: '이 값 미만이면 자동 에스컬',
      },
      {
        key: 'safe-domains',
        lbl: '자동응답 화이트리스트',
        val: '8 카테고리',
        desc: 'Labeling / Symbols / Language / SOUP 등',
      },
      {
        key: 'danger-keywords',
        lbl: '자동 에스컬 키워드',
        val: '12개',
        desc: 'recall · FSCA · MDR breach · CAPA · off-label …',
      },
    ],
    esig: [
      {
        ...
        lbl: '전자서명 방식',
        val: '비밀번호 재입력',
        desc: 'v3.2에서 WebAuthn / FIDO2 도입 예정',
      },
      { key: 'reauth', lbl: '세션 재인증 주기', val: '30분', desc: '연속 서명 시에도 재입력 요구' },
      {
        ...
        lbl: '감사로그 무결성',
        val: 'SHA-256',
        desc: 'Append-only · 21 CFR Part 11 §11.10(e)',
      },
    ],
    integrations: [
      ...
      {
        key: 'sharepoint',
        lbl: 'SharePoint 문서 저장소',
        val: 'Read-only',
        desc: 'DHF/RMF/CER 원본 조회 (v3.1)',
      },
    ...
    retention: [
      { key: 'inbox-ttl', lbl: 'Inbox 티켓 보관', val: '7년', desc: 'ISO 13485 §4.2.5 최소 기간' },
      {
        ...
        lbl: '감사 로그 보관',
        val: '10년',
        desc: '21 CFR Part 11 + MDR Art. 10(8)',
      },
      {
        key: 'consult-ttl',
        lbl: 'Consult 세션 보관',
        val: '5년',
        desc: 'RA 개인 리서치 · 명시적 삭제 가능',
      },
    ],
  },
  ...
  consultSessions: [
    ...
    },
    {
      ...
      turns: 9,
      saved: false,
      tags: ['PMDA', 'Pre-consult'],
    },
    {
      id: 'C-2026-034',
      title: 'IEC 60601-1-2 4판 EMC — Class II 면제 조항',
      updated: '2026-06-22',
      turns: 15,
      saved: true,
      tags: ['IEC', 'EMC'],
  ...
  consultDetails: {
    'C-2026-041': {
      ...
      question:
        'AI 알고리즘 재학습 배포 파이프라인에 PCCP를 적용할 수 있는지, FDA · EU · MFDS 각각의 관점에서 조건을 비교해줘.',
      confidence: 88,
      sources: 11,
      duration: '18.2s',
      trace: [
...
<b>MFDS</b>는 2026-06 SaMD 변경허가 가이드 v2.0을 의견조회 중입니다. FDA 프레임을 참고하되 국내 임상 데이터 요구가 추가될 것으로 예상됩니다<sup class="cite" data-src="5">5</sup>.`,
      comparison: {
        ...
        rows: [
          [
            '공식 프레임',
            'PCCP Final Guidance (2024-12)',
            'Art. 10(9) · MDCG 2024-9',
            'SaMD 변경허가 v2.0 (draft)',
          ],
          ['제출 시기', '510(k)/De Novo/PMA와 함께', 'CE 인증 시 · 사후 통지', '변경허가 신청 시'],
          [
            '적용 범위',
            'Modifications + Protocol + Impact',
            'CIP 프레임',
            '알고리즘 · 데이터 · 성능 지표',
          ],
      ...
      sourceList: [
        {
          idx: 1,
          org: 'FDA',
          title: 'Predetermined Change Control Plans for AI-Enabled Devices',
          year: '2024',
          type: 'Guidance',
        },
        {
          idx: 2,
          org: 'FDA',
          title: 'Marketing Submission Recommendations for AI/ML PCCP',
          year: '2024',
          type: 'Guidance',
        },
        {
          idx: 3,
          org: 'FDA',
          title: 'GMLP — Good Machine Learning Practice',
          year: '2021',
          type: 'Guidance',
        },
        {
          idx: 4,
          org: 'MDCG',
          title: 'MDCG 2024-9 — Software modifications',
          year: '2024',
          type: 'Guidance',
        },
        {
          idx: 5,
          org: 'MFDS',
          title: '의료기기 SaMD 변경허가 가이드 v2.0 (의견조회)',
          year: '2026',
          type: 'Draft',
        },
        {
          idx: 6,
          org: 'IMDRF',
          title: 'IMDRF/AIMD WG/N67 — ML-enabled Medical Device Key Terms',
          year: '2023',
          type: 'Standard',
        },
        {
          idx: 7,
          org: 'EU',
          title: 'Regulation (EU) 2017/745 — MDR Art. 10',
          year: '2017',
          type: 'Regulation',
        },
        {
          idx: 8,
          org: '사내',
          title: 'PCCP-SOP-001 · Regula 내부 절차',
          year: '2026',
          type: 'Internal',
        },
      ],
    ...
    'C-2026-039': {
      ...
      question:
        'MDR Annex XVI (비의료기기 목적 제품 — 미용용 콘택트렌즈, 필러 등)의 임상평가는 정확히 어떤 요구사항을 만족해야 하나?',
      confidence: 91,
      sources: 8,
      duration: '11.6s',
      trace: [
...
<b>PMCF는 필수</b>이며, 특히 이식형/침습적 제품(필러, 지방분해)은 상세한 사전·사후 임상 계획을 제출해야 합니다<sup class="cite" data-src="4">4</sup>.`,
      ...
      sourceList: [
        {
          idx: 1,
          org: 'EU',
          title: 'MDR Annex XVI — Groups of products without an intended medical purpose',
          year: '2017',
          type: 'Regulation',
        },
        {
          idx: 2,
          org: 'EU',
          title: 'Commission Implementing Regulation (EU) 2022/2346',
          year: '2022',
          type: 'Regulation',
        },
        {
          idx: 3,
          org: 'MDCG',
          title: 'MDCG 2020-13 — Clinical Evaluation Assessment Report Template',
          year: '2020',
          type: 'Guidance',
        },
        {
          idx: 4,
          org: 'MDCG',
          title: 'MDCG 2022-14 — Transition to MDR (Annex XVI specifics)',
          year: '2022',
          type: 'Guidance',
        },
        {
          idx: 5,
          org: 'MEDDEV',
          title: 'MEDDEV 2.7/1 rev.4 — Clinical Evaluation (still relevant)',
          year: '2016',
          type: 'Guidance',
        },
      ],
    ...
    'C-2026-036': {
      ...
      jurisdictions: ['pmda'],
      question:
        'NeuroTrack-EEG(Class II · 지정관리) PMDA 신청을 위한 사전상담(대면 조언, Type-II) 준비 자료 목록을 정리해줘.',
      confidence: 84,
      sources: 6,
      duration: '9.4s',
      trace: [
...
<b>수수료(2026)</b>: Type-II 상담 약 ¥2,300,000, 소요 6-8주.<sup class="cite" data-src="4">4</sup>`,
      ...
      sourceList: [
        {
          idx: 1,
          org: 'PMDA',
          title: 'Consultation on Medical Devices — Categories & Fees',
          year: '2026',
          type: 'Guidance',
        },
        {
          idx: 2,
          org: 'MHLW',
          title: '医薬品医療機器等法 (PMD Act) 第23条の2の3',
          year: '2013',
          type: 'Regulation',
        },
        {
          idx: 3,
          org: 'PMDA',
          title: 'Medical Device Review Handbook',
          year: '2024',
          type: 'Handbook',
        },
        { idx: 4, org: 'PMDA', title: 'Fee Schedule for FY2026', year: '2026', type: 'Schedule' },
        {
          idx: 5,
          org: 'JFMDA',
          title: 'Foreign Manufacturer Registration Guide',
          year: '2023',
          type: 'Industry',
        },
      ],
    ...
    'C-2026-034': {
      ...
      question:
        'IEC 60601-1-2:2020(4판) EMC 시험 중 Class II 의료기기에서 면제 가능한 항목이 있는가? 위험 기반 접근을 어떻게 정당화하나?',
      confidence: 79,
      sources: 9,
      duration: '14.1s',
      trace: [
...
<b>FDA 관점</b>: 4th ed는 recognition list에 등재됨. STED에 tailoring 근거를 명시하면 수용됨<sup class="cite" data-src="4">4</sup>.`,
      ...
      sourceList: [
        {
          idx: 1,
          org: 'IEC',
          title: 'IEC 60601-1-2:2020 (Ed 4.1) — EMC Requirements',
          year: '2020',
          type: 'Standard',
        },
        {
        ...
        },
        {
          idx: 3,
          org: 'IEC',
          title: 'IEC 60601-1-2 §4.2 · §5 — Risk-based tailoring provisions',
          year: '2020',
          type: 'Standard',
        },
        {
          idx: 4,
          org: 'FDA',
          title: 'CDRH Standards Recognition List (60601-1-2 Ed 4.1)',
          year: '2024',
          type: 'List',
        },
        {
          idx: 5,
          org: 'AAMI',
          title: 'Application Guide for 60601-1-2 Ed 4',
          year: '2021',
          type: 'Industry',
        },
      ],
    ...
    'C-2026-030': {
      ...
      jurisdictions: ['nmpa'],
      question:
        '중국 NMPA에 Class II 의료기기 등록 시, 한국(KTL/KTR) 시험성적서를 어느 범위까지 재활용 가능한가?',
      confidence: 76,
      sources: 7,
      duration: '12.7s',
      trace: [
      ...
      sourceList: [
        {
          idx: 1,
          org: 'NMPA',
          title: 'Order No.47 — Medical Device Registration Regulations (2021)',
          year: '2021',
          type: 'Regulation',
        },
        {
          idx: 2,
          org: 'NMPA',
          title: 'Announcement No.121 — Foreign Testing Report Acceptance',
          year: '2021',
          type: 'Announcement',
        },
        {
          idx: 3,
          org: 'CMDE',
          title: 'GB 9706 Series — Equivalence Table with IEC 60601',
          year: '2023',
          type: 'Guidance',
        },
        { idx: 4, org: 'CMDE', title: 'Pre-consultation Handbook', year: '2024', type: 'Handbook' },
        {
          idx: 5,
          org: 'ILAC',
          title: 'MRA Signatory List (KOLAS included)',
          year: '2024',
          type: 'List',
        },
      ],
