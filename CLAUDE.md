...
- [HARD] Issue-First Protocol: After any analysis or gap finding, run `gh issue list` to cross-verify, register missing gaps as issues, then report. Never report findings without issue registration first.
