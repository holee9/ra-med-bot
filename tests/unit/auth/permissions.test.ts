...
describe('lib/auth/permissions.ts (REQ-ENTERPRISE-020) — PERMISSIONS matrix', () => {
  it('PERMISSIONS contains exactly 77 entries', () => {
    expect(Object.keys(PERMISSIONS)).toHaveLength(77); // +2 corpuslicense.* (#72) +2 sourcegov.* (#48) +1 rlhf.feedback (#56) +2 knowledgepromo.* (#50) +2 standards.* (#62)
  });
